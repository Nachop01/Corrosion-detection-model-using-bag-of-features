...
|----------------------|-------------------------------------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| **Random Forest**    | Ensemble of decision trees         | - Number of trees<br>- Split criterion<br>- Min samples per leaf                    | (25, 50, 75, 100)<br>(Entropy, Gini Index)<br>(1, 2, 4, 8, 16, 32)                        | [View Code](ML_models/Random_Forest.ipynb  )                                   |
| **XGBoost**          | Gradient-boosted trees            | - Number of iterations<br>- Learning rate<br>- Min samples per leaf                | (25, 50, 75, 100, 125, 150)<br>(0.025, 0.05, 0.1, 0.2, 0.4)<br>(1, 2, 4, 8, 16, 32)      | [View Code](ML_models/XGBOOST.ipynb)                                           |
| **LightGBM (GOSS)**  | High-speed gradient boosting       | - High gradient rate<br>- Low gradient rate<br>- Learning rate<br>- Number of leaves| (0.2, 0.4, 0.6)<br>(0.05, 0.1, 0.3)<br>(0.025, 0.05, 0.1, 0.2, 0.4)<br>(10, 30, 50)      | [View Code](ML_models/LIGHTGBM_GOSS.ipynb)                                     |
| **LightGBM (GBDT)**  | High-speed gradient boosting       | - Number of iterations<br>- Learning rate<br>- Number of leaves                    | (25, 50, 75, 100, 125, 150)<br>(0.01, 0.05, 0.1, 0.5)<br>(10, 30, 50)                    | [View Code](ML_models/LIGHTGBM_GOSS.ipynb)                                     |
| **Logistic Regression** | Linear probabilistic classifier   | - Coefficients ($\beta_1,\dots,\beta_d$)                                           | $\beta_i \in \mathbb{R}$                                                                  | [View Code](ML_models/Logistic_regression.ipynb)                               |
| **SVM**              | Kernel-based separation            | - Kernel<br>- Error tolerance (C)                                                  | (Linear, Gaussian)<br>(0.001, 0.01, 0.1, 1)                                              | [View Code](ML_models/SVM.ipynb)                                               |
| **KNN**              | Distance-based instance learning   | - Distance metric<br>- Number of neighbors (k)                                     | (Euclidean, Manhattan)<br>(1, 3, 5, 11, 21, 41, 61)                                      | [View Code](ML_models/KNN.ipynb)                                               |
